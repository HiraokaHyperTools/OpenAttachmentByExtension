var oabeApi = class extends ExtensionCommon.ExtensionAPI {
  getAPI(context) {
    ...
    const getAttachmentsInActiveMail = () => {
      function forThunderbird115AndAbove() {
        return true
          && Services.wm.getMostRecentWindow("mail:3pane")
          && Services.wm.getMostRecentWindow("mail:3pane").gTabmail
          && Services.wm.getMostRecentWindow("mail:3pane").gTabmail.currentAboutMessage
